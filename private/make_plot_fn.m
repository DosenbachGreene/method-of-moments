...
function plot_clusters(B, u)
    ...
    if nargin == 1
        ...
        line(xrange, B(1) + u(1) + xrange.*(B(2) + u(4)), 'Color', scatter_h1.CData);
        line(xrange, B(1) + u(2) + xrange.*(B(2) + u(5)), 'Color', scatter_h2.CData);
        line(xrange, B(1) + u(3) + xrange.*(B(2) + u(6)), 'Color', scatter_h3.CData);
